...
const	ACTION_CALL           = 0x01
const	ACTION_REPLY_SUCCESS  = 0x02 // 别名
const	ACTION_REPLY_ERROR   = 0x03 // 别名
	// 无效操作
const	ACTION_INVALID       = 0x00
	//广播
const	ACTION_BROADCAST     = 0xFF
                ...
                if (window["WebSocket"]) {
                    ...
                    const rev = evt => {
                        ...
                        receive_message(this.sock, evt.data, msg => {
                            ...
                            if (callId && msgObj.action == ACTION_REPLY_SUCCESS) {
